...
st.set_page_config(page_title="Mi chat de IA", page_icon="9️⃣", layout="centered")  # Configura el título, ícono y diseño de la página
...
if st.button("Saludar"):  # Si el usuario hace clic en el botón "Saludar"
    st.subheader(f"Hola {nombre}! gracias por venir a Talento Tech")  # Muestra un saludo personalizado
...
def configurar_pagina():  # Función para configurar la página
    st.title("Mi chat de IA")  # Establece un título principal en la página
